<template>
  <!-- footer -->
  <div class="w-full px-4 py-6 bg-gray-300 ">
    <!-- marging just for display-->
    <div class="px-4 pt-3 pb-4 -mx-4 border-b border-gray-400">
      <div class="max-w-xl mx-auto">
        <h2 class="inline-block text-xl font-semibold text-left text-gray-800">
          Join Our Newsletter
        </h2>
        ...
        <form action="#" class="mt-2">
          <div class="flex items-center">
            ...
            />
            <button
              class="px-5 py-2 text-gray-200 bg-blue-600 rounded shadow "
    ...
    <footer class="text-gray-700 body-font">
      <div class="bg-gray-200">
        <div
          class="container flex flex-col items-center px-1 py-2 mx-auto sm:flex-row"
        >
          <a
